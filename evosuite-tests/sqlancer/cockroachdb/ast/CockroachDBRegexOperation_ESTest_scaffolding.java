...
public class CockroachDBRegexOperation_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.ast.CockroachDBRegexOperation"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBRegexOperation_ESTest_scaffolding.class.getClassLoader() ,
      "sqlancer.Randomly",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBRegexOperation_ESTest_scaffolding.class.getClassLoader()); 
