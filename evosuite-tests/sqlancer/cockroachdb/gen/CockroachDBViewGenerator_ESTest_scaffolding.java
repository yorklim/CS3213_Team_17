...
public class CockroachDBViewGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBViewGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBViewGenerator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.cockroachdb.gen.CockroachDBViewGenerator",
      "sqlancer.SQLancerDBConnection"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBViewGenerator_ESTest_scaffolding.class.getClassLoader()); 
