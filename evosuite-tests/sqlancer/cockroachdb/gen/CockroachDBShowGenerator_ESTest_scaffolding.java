...
public class CockroachDBShowGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBShowGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBShowGenerator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.cockroachdb.gen.CockroachDBShowGenerator$Option",
      "sqlancer.cockroachdb.gen.CockroachDBShowGenerator",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBShowGenerator_ESTest_scaffolding.class.getClassLoader()); 
