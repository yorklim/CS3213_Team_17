...
public class CockroachDBTruncateGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBTruncateGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBTruncateGenerator_ESTest_scaffolding.class.getClassLoader() ,
      "sqlancer.cockroachdb.gen.CockroachDBTruncateGenerator",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBTruncateGenerator_ESTest_scaffolding.class.getClassLoader()); 
