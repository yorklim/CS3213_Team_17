...
public class CockroachDBSetSessionGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBSetSessionGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBSetSessionGenerator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.cockroachdb.gen.CockroachDBSetSessionGenerator$CockroachDBSetting",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBSetSessionGenerator_ESTest_scaffolding.class.getClassLoader()); 
