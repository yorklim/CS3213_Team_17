...
public class CockroachDBGenerator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cockroachdb.gen.CockroachDBGenerator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CockroachDBGenerator_ESTest_scaffolding.class.getClassLoader() ,
      "sqlancer.cockroachdb.gen.CockroachDBGenerator",
      "sqlancer.MainOptions",
      "sqlancer.cockroachdb.gen.CockroachDBTableGenerator",
      "sqlancer.Randomly",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CockroachDBGenerator_ESTest_scaffolding.class.getClassLoader()); 
