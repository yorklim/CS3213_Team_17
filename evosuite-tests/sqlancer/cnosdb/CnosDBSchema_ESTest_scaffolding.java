...
public class CnosDBSchema_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.cnosdb.CnosDBSchema"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CnosDBSchema_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.cnosdb.client.CnosDBClient",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("sqlancer.cnosdb.CnosDBSchema$CnosDBTable", false, CnosDBSchema_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CnosDBSchema_ESTest_scaffolding.class.getClassLoader()); 
