...
public class DatabendQueryPartitioningDistinctTester_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.databend.test.tlp.DatabendQueryPartitioningDistinctTester"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DatabendQueryPartitioningDistinctTester_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DatabendQueryPartitioningDistinctTester_ESTest_scaffolding.class.getClassLoader()); 
