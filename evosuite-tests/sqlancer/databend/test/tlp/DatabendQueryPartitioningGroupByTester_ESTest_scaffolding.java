...
public class DatabendQueryPartitioningGroupByTester_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.databend.test.tlp.DatabendQueryPartitioningGroupByTester"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DatabendQueryPartitioningGroupByTester_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DatabendQueryPartitioningGroupByTester_ESTest_scaffolding.class.getClassLoader()); 
