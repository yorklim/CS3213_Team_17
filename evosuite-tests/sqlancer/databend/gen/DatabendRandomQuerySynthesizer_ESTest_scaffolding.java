...
public class DatabendRandomQuerySynthesizer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.databend.gen.DatabendRandomQuerySynthesizer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DatabendRandomQuerySynthesizer_ESTest_scaffolding.class.getClassLoader() ,
      "sqlancer.MainOptions",
      "sqlancer.databend.DatabendSchema$DatabendTable",
      "sqlancer.Randomly",
      "sqlancer.AbstractAction",
      "sqlancer.databend.gen.DatabendRandomQuerySynthesizer",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DatabendRandomQuerySynthesizer_ESTest_scaffolding.class.getClassLoader()); 
