...
public class CitusTLPHavingOracle_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "sqlancer.citus.oracle.tlp.CitusTLPHavingOracle"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CitusTLPHavingOracle_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "sqlancer.postgres.ast.PostgresSelect$PostgresSubquery",
      ...
      "sqlancer.postgres.ast.PostgresSelect$PostgresFromTable",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CitusTLPHavingOracle_ESTest_scaffolding.class.getClassLoader()); 
