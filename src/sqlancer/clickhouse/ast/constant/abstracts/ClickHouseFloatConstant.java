...
public abstract class ClickHouseFloatConstant<T extends Number> extends ClickHouseConstant {
    ...
    protected ClickHouseFloatConstant(T value) {
        this.value = value;
    }
    ...
    public boolean compareInternal(Object val) {
        return Double.compare(value.doubleValue(), ((Number) val).doubleValue()) == 0;
    }
    ...
    public boolean asBooleanNotNull() {
        return Double.compare(value.doubleValue(), 0.0) == 0;
    }
    ...
    public ClickHouseConstant cast(ClickHouseDataType type) {
        switch (type) {
            ...
            case Bool:
                return ClickHouseCreateConstant.createBooleanConstant(value.doubleValue() != 0);
            case IntervalYear:
